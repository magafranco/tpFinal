...
function draw() {
  ...
  if (estoyEn == "comienzo") {
    ...
    crearBoton(width / 2 - 220, 210, 200, 100, "Iglesia", cambiarEscena, "arbol1");
    image(foto[4], width / 2 - 220, 210, 200, 100);
    text("Explorar Iglesia abandonada", width / 2 - 220 + 100, 210 + 50);
    crearBoton(width / 2 - 100 + 120, 210, 200, 100, "Ratro", cambiarEscena, "rastro1");
    image(foto[5], width / 2 - 100 + 120, 210, 200, 100);
    text("Seguir Rastro", width / 2 - 220 + 340, 210 + 50);
    crearBoton(width / 2 - 220, 340, 200, 100, "Bosque", cambiarEscena, "bosque1");
    image(foto[1], width / 2 - 220, 340, 200, 100);
    text("Explorar Bosque", width / 2 - 220 + 100, 340 + 50);
    crearBoton(width / 2 - 100 + 120, 340, 200, 100, "Lago", cambiarEscena, "lago1");
